...
export const applyShowerSkillEffectToLocation = (
    position: Vector3,
    duration?: number
) => {
    ...
    const gltfShape20 = new GLTFShape("models/Skill_FX/Anubis.glb")
    ...
    const actionClip = new AnimationState("attack", { looping: true })
