...
const POSITIONS = [
  new Vector3(80.73, 2.27, 67.93),
  new Vector3(57.94, 1.62, 72.21),
  new Vector3(85.2, 2.17, 102.63),
  new Vector3(99.73, 12.0, 37.4),
  new Vector3(81.99, 10.07, 79.2),
  new Vector3(67.49, 17.07, 72.04),
];
...
export default class GameManagerHouse {
            ...
            setTimeout(Math.round(i * 1.5) * 2000, () => {
              ...
              if (
                ...
                zombie = new FastZombie(
                  new GLTFShape("models/ghost.glb"),
                  moveSpeed,
                  new Transform({
                    position:
                      POSITIONS[getRandomInt(POSITIONS.length)]?.clone(),
